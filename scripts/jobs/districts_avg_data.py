...
def scrape_district_avg_data(input_files: Optional[List[str]] = None) -> None:
    """
    Main function to process PM2.5 data and create AQI raster files.

    Args:
        input_files: Optional list of file paths to process. If None, will glob the default directory.
    """
    try:
...
__all__ = ["scrape_district_avg_data"]

if __name__ == "__main__":
    scrape_district_avg_data()
