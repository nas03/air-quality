  ...
  return (
    <div
      className={cn(
        ...
        "bg-3 absolute bottom-0 flex h-fit flex-row items-center gap-16 rounded-md bg-white/50 pb-2 pl-10 pr-16 pt-5 font-roboto backdrop-blur-md transition-all duration-150",
      )}
    >
