    ...
    <Loading loading={loading} className="h-screen bg-gray-50">
      <div className="flex h-full w-full flex-col items-center justify-center">
        <div className="w-full max-w-md rounded-lg bg-white p-6 shadow-md">
          ...
          <h1 className="mb-2 text-center text-2xl font-bold text-blue-700">Tài khoản của bạn đã được kích hoạt!</h1>
          <p className="mb-4 text-center text-gray-600">
            Cảm ơn bạn đã xác nhận email. Bạn có thể bắt đầu sử dụng hệ thống giám sát chất lượng không khí ngay bây
            giờ.
          </p>
