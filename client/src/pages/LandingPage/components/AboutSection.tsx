        ...
        <div className="flex flex-col-reverse items-center gap-12 lg:flex-row">
          <div className="space-y-4 lg:w-1/2">
            <p className="text-lg text-gray-600">
              Airly là giải pháp tiên tiến giúp dự báo chính xác chất lượng không khí dựa trên chỉ số PM2.5 cho toàn
              bộ lãnh thổ Việt Nam.
            </p>
            <p className="text-lg text-gray-600">
              Sử dụng công nghệ trí tuệ nhân tạo hiện đại, Airly cung cấp dự báo chi tiết trong 7 ngày tới với độ phân
              giải cao 1km trên mọi tỉnh thành đất liền của Việt Nam.
            </p>
          </div>
